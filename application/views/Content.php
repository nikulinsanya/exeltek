...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="<?= URL::base() ?>"><img src="<?= URL::base() ?>img/logo.png" height="30"
                                                                   alt="Dashboard"/></a>
        </div>
        <div id="navbar" class="collapse navbar-collapse">
            <ul class="nav navbar-nav">
                <li class="<?= Request::current()->directory() == '' && Request::current()->controller() == 'Search' ? 'active' : '' ?>">
                    <a href="<?= URL::base() ?>search">Search</a></li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Dashboard
                        <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li class="<?= Request::current()->controller() == 'Dashboard' && Request::current()->action() == 'reports' ? 'active' : '' ?>">
                            <a href="<?= URL::base() ?>dashboard/reports">Reports</a></li>
                        <li class="<?= Request::current()->controller() == 'Dashboard' && Request::current()->action() == 'fsa' ? 'active' : '' ?>">
                            <a href="<?= URL::base() ?>dashboard/fsa">FSA progress</a></li>
                        <li class="<?= Request::current()->controller() == 'Dashboard' && Request::current()->action() == 'lifd' ? 'active' : '' ?>">
                            <a href="<?= URL::base() ?>dashboard/lifd">LIFD progress</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Reports
                        <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        <li class="<?= Request::current()->directory() == 'Reports' && Request::current()->controller() == 'Submissions' ? 'active' : '' ?>">
                            <a href="<?= URL::base() ?>reports/submissions">Submissions</a></li>
                        <?php if (Group::current('allow_finance')): ?>
                            <li class="<?= Request::current()->directory() == 'Reports' && Request::current()->controller() == 'Financial' ? 'active' : '' ?>">
                                <a href="<?= URL::base() ?>reports/financial">Financial</a></li>
                        <?php endif; ?>
                        <?php if (Group::current('allow_custom_forms')): ?>
                            <li class="<?= Request::current()->directory() == '' && Request::current()->controller() == 'Form' ? 'active' : '' ?>">
                                <a href="<?= URL::base() ?>form/unattached">Unattached Forms</a></li>
                            <li class="<?= Request::current()->directory() == 'Reports' && Request::current()->controller() == 'Forms' ? 'active' : '' ?>">
                                <a href="<?= URL::base() ?>reports/forms">Forms Reports</a></li>
                        <?php endif; ?>
                    </ul>
                </li>
                <?php if (Group::current('allow_reports')): ?>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Import
                            / Export <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li class="<?= Request::current()->directory() == 'Imex' && Request::current()->controller() == 'Upload' ? 'active' : '' ?>">
                                <a href="<?= URL::base() ?>imex/upload">Jobs upload</a></li>
                            <li class="<?= Request::current()->directory() == 'Imex' && Request::current()->controller() == 'Reports' ? 'active' : '' ?>">
                                <a href="<?= URL::base() ?>imex/reports">Jobs reports</a></li>
                            <li class="<?= Request::current()->directory() == 'Imex' && Request::current()->controller() == 'Discrepancies' ? 'active' : '' ?>">
                                <a href="<?= URL::base() ?>imex/discrepancies">SOD Discrepancies</a></li>
                            <li class="<?= Request::current()->directory() == 'Imex' && Request::current()->controller() == 'Export' ? 'active' : '' ?>">
                                <a href="<?= URL::base() ?>imex/export">Jobs export</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Defects
                            <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li class="<?= Request::current()->directory() == 'Defects' && Request::current()->controller() == 'Upload' ? 'active' : '' ?>">
                                <a href="<?= URL::base() ?>defects/upload">Defects upload</a></li>
                            <li class="<?= Request::current()->directory() == 'Defects' && Request::current()->controller() == 'Reports' && Request::current()->action() == 'index' ? 'active' : '' ?>">
                                <a href="<?= URL::base() ?>defects/reports">Defects reports</a></li>
                        </ul>
                    </li>
                <?php endif; ?>
                <?php if (Group::current('is_admin')): ?>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Security
                            <span class="caret"></span></a>
                        <ul class="dropdown-menu">
                            <li class="<?= Request::current()->directory() == 'Security' && Request::current()->controller() == 'Users' ? 'active' : '' ?>">
                                <a href="<?= URL::base() ?>security/users">Users</a></li>
                            <li class="<?= Request::current()->directory() == 'Security' && Request::current()->controller() == 'Groups' ? 'active' : '' ?>">
                                <a href="<?= URL::base() ?>security/groups">Groups</a></li>
                            <li class="<?= Request::current()->directory() == 'Security' && Request::current()->controller() == 'Companies' ? 'active' : '' ?>">
                                <a href="<?= URL::base() ?>security/companies">Companies</a></li>
                            <li class="<?= Request::current()->directory() == 'Security' && Request::current()->controller() == 'Rates' ? 'active' : '' ?>">
                                <a href="<?= URL::base() ?>security/rates">Rates</a></li>
                            <li class="<?= Request::current()->directory() == 'Security' && Request::current()->controller() == 'Columns' ? 'active' : '' ?>">
                                <a href="<?= URL::base() ?>security/columns">Columns</a></li>
                            <li class="<?= Request::current()->directory() == '' && Request::current()->controller() == 'Form' ? 'active' : '' ?>">
                                <a href="<?= URL::base() ?>form">Forms</a></li>
                            <li class="<?= Request::current()->directory() == 'Security' && Request::current()->controller() == 'Reports' ? 'active' : '' ?>">
                                <a href="<?= URL::base() ?>security/reports">Reports</a></li>
                            <li class="<?= Request::current()->directory() == 'Security' && Request::current()->controller() == 'Structure' ? 'active' : '' ?>">
                                <a href="<?= URL::base() ?>security/structure">Structure</a></li>
                            <li class="<?= Request::current()->directory() == 'Security' && Request::current()->controller() == 'Enums' ? 'active' : '' ?>">
                                <a href="<?= URL::base() ?>security/enums">Enumerations</a></li>
                        </ul>
                    </li>
                <?php endif; ?>
...
<div class="modal fade" id="modal-download" tabindex="-1" role="dialog">
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                Files count: <b><span id="download-count">0</span></b>/<b><span
                        id="download-count-total">0</span></b><br/>
                Total size: <b><span id="download-size">0 B</span></b>/<b><span
                        id="download-size-total">0</span></b><br/>
            </div>
        </div>
    </div>
</div>
