...
<tr class="text-center">
    ...
    <th>Regions</th>
    <th>Last login</th>
    <th><a href="<?=URL::base()?>security/users/edit" class="btn btn-success show-content-in-popup">Add</a></th>
</tr>
...
<tr class="text-center">
    ...
    <td>
        <a href="<?=URL::base()?>security/users/edit/<?=$item['id']?>" class="btn btn-warning show-content-in-popup">Edit</a>
