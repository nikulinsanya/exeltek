...
//        self.updateLines();
    ...
    self.collapseAll = function(){
        $('tr.expanded[data-level="1"]').trigger('click')
    };

    self.expandAll = function(){
        self.caller.find('tr:not(.expanded):not(.header):not([data-level="4"])').trigger('click');
    };

    $.fn.tabelize = function(confProp,methodName){
